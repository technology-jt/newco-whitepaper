...
{% hint style="danger" %}
1. Who created this, and why? What am I missing?
2. How can I trust the other side of the transaction? Is this a scam?
3. Why didn't I catch this before, and how I do find more projects like this?
4. Do I know anyone else involved? How do I connect with them?&#x20;
{% endhint %}

And after that initial uncertainty drips away, you probably ape in head first. And again. And again.
...
Between different wallets across ten chains, five different chat room apps all trying to accomplish the same thing, and the general sense of friction when interacting with the space - it's become a full-time job.
...
We want to walk you through a few of the key ideas that helped us develop <mark style="color:purple;">Veld View</mark> before diving into the application itself.

This document will serve as an up-to-date white paper outlining our goals, initiatives, and development behind <mark style="color:purple;">Veld View</mark>. The document is structured first as a narrative to the founding of the Company and the application, and then transition to higher-level product specs and our roadmap for API / digitalization. We aim to update it often.
...
The space has, and will continue to evolve at supersonic speed. We're here to build something that will survive change.

<mark style="color:purple;">Veld View</mark> by design will only grow with adoption. Integrate your identity on the chain, in a truly additive fashion. And for one reason or another, we're always headed towards next veld.&#x20;
